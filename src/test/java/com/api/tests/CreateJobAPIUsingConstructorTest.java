...
public class CreateJobAPIUsingConstructorTest {
	
	@Test
	public void createJobAPITest()
	{
		
		Customer customer = new Customer("Vaibhav","Suryavanshi","843-865-3213","843-865-3534","Vaibhav_Aufderhar@gmail.com","");
		...
		CreateJobPayload jobPayload = new CreateJobPayload(0,2,1,1,customer,address,product,problems);		
